...
{
    public QDrawMode _drawMode = QDrawMode.INSERT;
    public Vector2 _totalArea = new Vector3(64f, 64f);
    public Quadtree _tree = null;
    ...
    public void Stat()
    {
        Dictionary<int, List<QNode>> allNodes = _tree.GetAllNodes();
    ...
    protected void OnDrawGizmos()
    {
        ...
        else if(_drawMode == QDrawMode.QUERY)
        {
            // 질의할 영역 그리기 ( 빨간색 )
